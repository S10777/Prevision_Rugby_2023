...
def simulate_match(home_team, away_team, temperature, precipitation):
    ...
    if not cotes_row.empty:
        ...
        return score_potential, avg_home_score, avg_away_score, odd_1, odd_2
    else:
        score_potential = avg_home_score + avg_away_score + temperature - precipitation
        return score_potential, avg_home_score, avg_away_score, None, None
...
def simulate():
    ...
    score_potential, avg_home_score, avg_away_score, odd_1, odd_2 = simulate_match(home_team, away_team, temperature, precipitation)

    if score_potential is None:
        return render_template('error.html', message="Équipes invalides. Veuillez saisir des équipes valides.")
    
    return render_template('result.html', score_potential=score_potential, avg_home_score=avg_home_score, avg_away_score=avg_away_score, odd_1=odd_1, odd_2=odd_2)
